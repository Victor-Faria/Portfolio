...
function startDelayedTextAnimation() {
  let phrase =
    " <p> I am a passionate and dedicated Front-end Developer,specializing in creating engaging and functional user interfaces for small and medium-sized businesses. Currently, i work on projects as a Freelancer, aiming to build my experience through direct contact with clients. My background at UNICAMP and experiences in the teaching field provides me with communication skills and empathy work with my clients while offering a great costumer service. I am committed to delivering high-quality work, whether developing new websites from scratch or improving existing platforms. Get in touch and lets build something great together! <p> ";
